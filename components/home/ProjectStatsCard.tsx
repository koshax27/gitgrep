...
export function ProjectStatsCard({ project, onRemove }: ProjectStatsCardProps) {
  ...
  return (
    <div className="bg-[#0d1117] border border-white/10 rounded-2xl p-5 hover:border-blue-500/50 transition-all">
      ...
      <div className="flex gap-2 mt-3">
        ...
        <button 
          onClick={() => {
            // هنا هتضيف الـ Security Scan logic
            const event = new CustomEvent('navigate', { detail: 'security' });
